...
<div>
  <div class="fh5co_heading fh5co_heading_border_bottom py-2 my-3">Other</div>
</div>

<!-- category 01 load -->
<div class="owl-carousel owl-theme" id="slider1">
  <?php
  $result = $conn->query("SELECT * FROM `posts` WHERE `status` = 1 AND `category` = 'Other' ORDER BY `create_at` DESC ");
    ...
    <div class="item px-2">
      <div class="fh5co_hover_news_img">
        ...
        <div>
          ...
          <div class="cont-location">Matara</div>
