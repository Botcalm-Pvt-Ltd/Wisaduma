...
<div class="owl-carousel owl-theme" id="slider4">
  <?php
  $result = $conn->query("SELECT * FROM `posts` WHERE `status` = 1 AND `category` = 'Unsafe Electrical' ORDER BY `create_at` DESC");
      ...
      <div class="item-inner">
        ...
        <div>
          ...
          <div class="progress mt-2 mb-3" style="height: 5px; ">
            <div class="progress-bar" style="width:75%; background:#0069AC;"></div>
          </div>
